...
namespace {
	...
	void ConfigMenuDraw(std::int32_t& ConfigCursorPosY) noexcept {
		...
		std::array<std::int32_t, 5> Container = { ConfigData.BackGroundMusicVolume, ConfigData.SoundEffectVolume, ConfigData.AutoSpeedVolume, ConfigData.SkipSpeedVolume,  ConfigData.ScriptDrawSpeedVolume };
